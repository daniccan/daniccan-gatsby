...
const Header = ({ siteTitle }) => (
  <header className="container m-auto px-4 md:px-20 max-w-screen-xl h-32">
    <nav className="mt-auto h-full flex space-x-6 items-center text-sm">
      ...
      <span className="hidden md:flex flex-grow items-center tracking-widest">
        <Link to="/">{siteTitle}</Link>
      </span>
      <span className="hidden md:flex items-center space-x-6 tracking-widest">
        <Link to="/">HOME</Link>
